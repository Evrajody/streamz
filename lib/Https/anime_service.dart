...
import '../tools/streamz_constants.dart';

/// [AnimeService] est une service qui permet de recuperer les anime en
/// ligne grace au element html
class AnimeService {
  ...
  Future<AnimeResults> getAnimes(request) async {
    ...
    /// La reponse recu est le code html de la page
    /// Grace au selecteur js on peur recuperer les elements cibles
    /// Pour forme les champs de la class anime;
    ///
    /// Recupere tout les elements ayant la classe items
    /// Premiers enfants du genre !!
    var list = document.getElementsByClassName('items').first.children;

    /// Recupère les images
    /// Ce sont les premieres valeurs des attributs des elements de classe imgs
